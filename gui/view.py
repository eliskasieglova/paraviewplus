...
class SimulationConfiguration(ctk.CTkFrame):
    ...
    def show_var_config(self, c0, c2, c3, c5, c6):
        self.variable_config = VariableConfigure(self, c0, c2, c3, c5, c6)
...
class SideBar(ctk.CTkFrame):
    ...
    def main_input(self):
        ...
        self.input_segmented_button = ctk.CTkSegmentedButton(self.main_input_frame, values=['Browse', 'Ferda'], command=self.input_segmented_button_command)
        self.input_segmented_button.pack(side='top', pady=(4,0))
        self.input_segmented_button.set('Browse')
    ...
    def browse_input(self):
        ...
        # TO REMOVE
        self.path_bar.insert(0,"data\surface_triangle_SHP.shp")

        self.browse_button = ctk.CTkButton(browse_button_frame, text='Browse', width=80)
        self.browse_button.pack(side='left')
        
        search_label2 = ctk.CTkLabel(browse_frame, text="Air Points")
    ...
    def simulation_type(self):
        ...
        checkbox_6 = ctk.CTkCheckBox(sim_frame, text="Windrose",border_width = 2,variable=self.check_var_6, onvalue="on", offvalue="off", state='disabled')
