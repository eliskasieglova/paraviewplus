...
class Controller:
    ...
    def on_submit(self):
        ...
        if show_aoi:
            ...
            self.gui.sim_config.show_var_config( self.gui.side_bar.check_var_0.get(),self.gui.side_bar.check_var_2.get(),self.gui.side_bar.check_var_3.get(),self.gui.side_bar.check_var_5.get(),self.gui.side_bar.check_var_6.get())
    ...
    def on_next(self):
        ...
        self.gui.sim_config.variable_config.back_button.configure(command=self.on_config_back)
        
    def on_config_back(self):
        self.gui.sim_config.variable_config.pack_forget()
        self.gui.sim_config.areas_of_intrest_picker.pack(side='top', fill='both', expand=True)
